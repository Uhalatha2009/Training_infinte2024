    ...
    class Program
    {
        ...
        static void AdminLogin()
        {
            ...
            if (int.TryParse(password.ToString(), out Admin_Password))
            {
                ...
                if (Admin_Name == "uha" && Admin_Password == 1234)
                {
                    // Admin operations 
                    Console.WriteLine("----------------------------:");
                    Console.WriteLine("Enter 1 for Adding train");
                    Console.WriteLine("Enter 2 for modify train");
                    Console.WriteLine("Enter 3 for Delete train");
                    Console.WriteLine("Enter 4 for Activate train");
                    Console.WriteLine("Enter 5 for Show All trains");
                    Console.WriteLine("Enter 6 for show all bookings");
                    ...
                    switch (choice)
                    {
                        case 1:
                            ...
                            break;
                        case 2:
                            Console.WriteLine(" modify the train");
                            Display_Train();
                            Modify_Train();
                            break;
                        case 3:
                            Console.WriteLine(" delete the train");
                            Delete_Train();
                            Display_Train();
                            break;
                        case 4:
                            Console.WriteLine("Enter the Train Name to activate:");
                            string trainNameToActivate = Console.ReadLine();
                            Activate_Train(trainNameToActivate);
                            Display_Train();
                            break;
        ...
        static void Display_Train()
        {
            ...
            Console.WriteLine("| Train Nunmer | Train Name  | Source Station  | Destination Station  | Status |");
        ...
        static void Activate_Train(string trainName)
        {
            // Retrieve the train from the database by its name
            var trainToActivate = db.Trains.FirstOrDefault(t => t.Train_Name == trainName);
            ...
            {
                Console.WriteLine("Train with the provided name does not exist.");
            }
        }
        ...
        static void UserLogin()
        {
            ...
            Console.WriteLine("Enter 1 for Book Ticket");
            Console.WriteLine("Enter 2 for Print Ticket");
            Console.WriteLine("Enter 3 for Cancel Ticket");
            Console.WriteLine("---------------------------------------------------");
            Console.Write("Enter your choice: ");
            int choice = Convert.ToInt32(Console.ReadLine());
            switch (choice)
        ...
        static void displayticketDisplayTicketClass_Detail()
        {
